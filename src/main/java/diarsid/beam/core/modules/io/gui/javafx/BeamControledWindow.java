 ...
 * @author Diarsid
 */ 
public abstract class BeamControledWindow implements Comparable<BeamControledWindow> {    
    ...
    BeamControledWindow(GuiJavaFXResources resources, WindowManager windowManager) {
    ...
    @Override
    public int compareTo(BeamControledWindow other) {
