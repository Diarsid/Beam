...
class SinglePageInDirectoryServlet extends HttpServlet {
    ...
    SinglePageInDirectoryServlet(PagesManagerModule pagesModule, PathResolver resolver) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<WebPage> pages = this.pagesModule.getWebPagesByNameInDirAndPlace(
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        if ( this.pagesModule.deleteWebPage(page, dir, place)) {
            response.setStatus(HttpServletResponse.SC_OK); 
                response.setHeader("Access-Control-Allow-Origin", "*");
            response.getWriter().close();
        } else {
