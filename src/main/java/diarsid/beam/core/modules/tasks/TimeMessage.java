 ...
 * @author Diarsid
 */
public class TimeMessage implements Serializable, Comparable<TimeMessage> {
    
    private final LocalDateTime time;
    private final String[] content;
    
    public TimeMessage(LocalDateTime time, String[] content) {
        this.time = time;
    ...
    public boolean equals(Object obj) {
        ...
        final TimeMessage other = (TimeMessage) obj;
    ...
    @Override
    public int compareTo(TimeMessage task) {
