...
public class ParserForPlusMinutesPattern implements TimePatternParser {
    
    public ParserForPlusMinutesPattern() {
    }
    ...
    public LocalDateTime parse(String timePattern) {
        return now().plusMinutes(this.parseMinutes(timePattern)).withSecond(0).withNano(0);
    }
