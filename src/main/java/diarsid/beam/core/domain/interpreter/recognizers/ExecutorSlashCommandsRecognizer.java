...
import diarsid.beam.core.domain.interpreter.Recognizer;


public class ExecutorSlashCommandsRecognizer implements Recognizer {
    
    public ExecutorSlashCommandsRecognizer() {
    }
