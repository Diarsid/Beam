...
import static diarsid.beam.core.control.io.interpreter.StreamArgumentsInterceptor.ArgumentType.NUMBER;
import static diarsid.beam.core.control.io.interpreter.StreamArgumentsInterceptor.ArgumentType.TIME_PERIOD;
import static diarsid.beam.core.domain.entities.TimePeriod.parseTimePeriodFrom;
import static diarsid.beam.core.util.StringNumberUtils.parseNumberElseZero;
