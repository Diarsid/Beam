...
package com.drs.beam.server.entities.task.util;
...
public class TaskTimeFormatter {
     ...
     */
    public LocalDateTime ofFormat(String timeString, boolean mustBeFuture) 
            throws 
    ...
    public String outputTimePatternFormat(LocalDateTime time){
