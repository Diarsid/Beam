...
public class OSWindows implements OS{    
    ...
    public void openLocation(Location location){
        ...
        this.ioEngine.reportInfo("opening...");
    }
    ...
    public void openFileInLocationWithProgram(String file, Location location, String program){
        ...
        if (file.length()>0 && program.length()>0){
            ...
            this.ioEngine.reportInfo("running...");
        }
    }
    ...
    public boolean checkIfDirectoryExists(String location){
        ...
        if (!dir.exists()) {
            this.ioEngine.reportInfo("This path doesn`t exists.");
            return false;
        } else if (!dir.isDirectory()) {
            this.ioEngine.reportInfo("This isn`t a directory.");
            return false;
        } else {
            return true;
        }        
    ...
    private String checkNameInDirectory(
        ...
        if (dir.exists() && dir.isDirectory()){
            ...
            if (foundItems.size() == 1){
                ...
                this.ioEngine.reportInfo(noTargetMessage);
                return "";
            }
        } else {
            this.ioEngine.reportInfo(noLocationMessage);
            return "";
        }
    } 
    ...
    private List<String> findItemsInDirectoryByNameParts(File directory, String nameToFind, List<String> foundItems){
        ...
        for(String file : directory.list()){
            ...
            if (containsAllFragments) foundItems.add(file);
        }
        return foundItems;
    }
    ...
    private String chooseOneVariantFrom(List<String> variants){
        ...
        if (variantNumber > 0){
            ...
            this.ioEngine.reportInfo("There are no external IO engine now.");
            return "";
        } else {
            return "";
        }   
