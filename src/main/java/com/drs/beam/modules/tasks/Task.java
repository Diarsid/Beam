...
public class Task implements Comparable<Task>, Serializable{
    ...
    /*
     * Static method to create new tasks.
     * Defines it`s type (task or calendar event), execution time and content.
     * New task`s ID generation is automatic and performed by getNextID() method.
     */
    ...
    /*
     * Static method for restoring tasks from data base for further manipulations.
     * Explicit defines restored task`s ID obtained from database.
     */
    ...
    /*
     * When program starts work after a period of it`s inactivity, TaskManager obtains 
     * the highest ID value from database and assigns this value to idGen through this method.
     */
