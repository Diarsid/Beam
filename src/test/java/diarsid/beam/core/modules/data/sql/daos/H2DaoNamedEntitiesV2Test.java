 ...
 * @author Diarsid
 */
public class H2DaoNamedEntitiesV2Test {
    
    private static final Logger logger = LoggerFactory.getLogger(H2DaoNamedEntitiesV2Test.class);
    ...
    public H2DaoNamedEntitiesV2Test() {
    }
    ...
    private static void prepareComponents() {
        ...
        dao = new H2DaoNamedEntitiesV2(dataBase, ioEngine, programsCatalog);
    }
