 ...
 * @author Diarsid
 */
public class H2DaoCommandsV2Test {
    
    private static final Logger logger = LoggerFactory.getLogger(H2DaoCommandsV2Test.class);
    ...
    public static void setUpClass() throws Exception {
        ...
        dao = new H2DaoCommandsV2(dataBase, ioEngine);
    ...
    @Test
    public void testFullSearchByOriginalPatternPartsOfType_case_typos() {
        List<InvocationCommand> commands = 
                dao.searchInOriginalByPatternAndType(initiator, "netxprozy", OPEN_LOCATION);
        assertEquals(2, commands.size());
    }
