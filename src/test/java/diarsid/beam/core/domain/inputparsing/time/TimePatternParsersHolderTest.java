...
import static diarsid.beam.core.domain.inputparsing.time.TimeParsing.parsersHolder;
...
public class TimePatternParsersHolderTest {
    ...
    private final static TimePatternParsersHolder parsersHolder = parsersHolder();
    ...
    public void parse_plusMinutesM() {
        String time = "+3m";
        Optional<TasksTime> optTime = parsersHolder.parse(time);
