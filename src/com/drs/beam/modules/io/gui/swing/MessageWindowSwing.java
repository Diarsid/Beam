 ...
 * @author Diarsid
 */
public class MessageWindowSwing {
    // Fields =============================================================================
    private final JFrame frame = new JFrame();
    
    // Constructors =======================================================================
    public MessageWindowSwing() {
    }
    ...
    public void invoke(String message, boolean isCritical) {
        ImageIcon icon = new ImageIcon(Gui.IMAGES_LOCATION+"message_ico.jpeg");
        ...
        JLabel timeLabel = new JLabel(message);
        ...
        ImageIcon image = new ImageIcon(Gui.IMAGES_LOCATION+"message.jpeg");
